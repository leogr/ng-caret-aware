...
e.setPosition=function(a){if(!isNaN(parseFloat(a))&&isFinite(a))return l(a),e;throw new TypeError('Position MUST be numeric.');};e.b=function(){return k().end};e.getSelection=k;e.getNamespace=e.a;e.setPosition=e.setPosition;e.getPosition=e.b}n.$inject=['$scope','$element','$attrs'];function q(){}q.prototype.link=function(f,h,p,g){h.on('keydown keyup click',function(){f.$evalAsync(function(){f[g.a()]=g.b()})});f.$watch(g.a(),function(b){g.b()!==b&&g.setPosition(b)});f.$on('$destroy',function(){delete f[g.a()];h.off('keydown keyup click')})};angular.module('leodido.caretAware',[]).directive('caretAware',function(){var f=new q;return{restrict:'AC',require:'caretAware',controller:n,link:f.link}});})();
